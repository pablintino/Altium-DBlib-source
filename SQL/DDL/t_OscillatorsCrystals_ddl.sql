DROP TABLE IF EXISTS t_OscillatorsCrystals;

CREATE TABLE t_OscillatorsCrystals
(
    ...
    `Frequency`                     VARCHAR(127) DEFAULT NULL,
    `FrequencyStability`            VARCHAR(127) DEFAULT NULL,
    `FrequencyTolerance`            VARCHAR(127) DEFAULT NULL,
    `LoadCapacitance`               VARCHAR(127) DEFAULT NULL,
    `ESREquivalentSeriesResistance` VARCHAR(127) DEFAULT NULL,
    `OperatingMode`                 VARCHAR(127) DEFAULT NULL,
...
DROP VIEW IF EXISTS OscillatorsCrystals;

CREATE VIEW OscillatorsCrystals AS
SELECT `comment`                       AS `Comment`,
       ...
       `ESREquivalentSeriesResistance` AS `ESR (Equivalent Series Resistance)`,
