DROP TABLE IF EXISTS t_FerriteBeads;

CREATE TABLE t_FerriteBeads
(
    ...
    `FilterType`                VARCHAR(127) DEFAULT NULL,
    `NumberofLines`             VARCHAR(127) DEFAULT NULL,
    `ImpedanceFrequency`        VARCHAR(127) DEFAULT NULL,
    `CurrentRatingMax`          VARCHAR(127) DEFAULT NULL,
    `DCResistanceDCRMax`        VARCHAR(127) DEFAULT NULL,
    ...
    `HeightMax`                 VARCHAR(127) DEFAULT NULL,
...
DROP VIEW IF EXISTS Ferrite_Beads;

CREATE VIEW Ferrite_Beads AS
SELECT `comment`                             AS `Comment`,
       ...
       `CurrentRatingMax`                    AS `Current Rating (Max)`,
       `DCResistanceDCRMax`                  AS `DC Resistance (DCR) (Max)`,
       ...
       `HeightMax`                           AS `Height (Max)`,
       `ImpedanceFrequency`                  AS `Impedance @ Frequency`,
       ...
       `NumberofLines`                       AS `Number of Lines`,
